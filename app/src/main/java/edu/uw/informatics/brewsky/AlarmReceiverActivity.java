...
public class AlarmReceiverActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // TODO: create an alert for timers
        AlertDialog alertDialog = new AlertDialog.Builder(AlarmReceiverActivity.this).create();
        alertDialog.setTitle("Robby Brosman's Dialog");
        alertDialog.setMessage("Dialog.");
        alertDialog.setIcon(R.drawable.abc_ab_share_pack_holo_dark);
        alertDialog.show();
    }
